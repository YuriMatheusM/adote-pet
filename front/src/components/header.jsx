...
const Header = () => {
  return (
    <header className="fixed w-full bg-[#eae5d5] 2xl:shadow-sm z-50">
      <nav className="items-center py-2 2xl:mr-44 2xl:w-full 2xl:flex-col 2xl:mb-4 2xl:items-center z-50">
        ...
        <div className="hidden 2xl:flex 2xl:justify-end 2xl:px-60 xl:gap-28 2xl:gap-96 2xl:w-full">
          ...
          <div className="lg:hidden 2xl:flex 2xl:justify-end 2xl:gap-3">
